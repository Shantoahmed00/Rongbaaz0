...
#--- Def menu ---#
def banner():
    os.system('printf "\r\r_  _ ____ _    _ ____ _ ____ _  _ ____\n\r\r|\/| |__| |    | |    | |  | |  | [__ \n\r\r|  | |  | |___ | |___ | |__| |__| ___]\n\n" | lolcat')
      #print(""R+"M "+C+"╭━━━╮╱╱╱╱╱╱╱╱╭╮╱╱╱╱╱╱╱╱╱╱╱╱╭━━━━╮"+R+"M")
     #print(""+R+"T "+C+"┃╭━╮┃╱╱╱╱╱╱╱╱┃┃╱╱╱╱╱╱╱╱╱╱╱╱┃╭╮╭╮┃"+R+"T") 
    # print(""+R+"A "+C+"┃╰━╯┣━━┳━╮╭━━┫╰━┳━━┳━━┳━━━╮╰╯┃┃┣┫╭╮"+R+"A")  
    #print(""+R+"I "+C+"   ┃╭╮╭┫╭╮┃╭╮┫╭╮┃╭╮┃╭╮┃╭╮┣━━┃┃╱╱┃┃┃╰╯┃"+R+"I")     
...
#    print(""+R+"! "+C+"  ╱╱╱╱╱╱╱╱╱╱╰━━╯ "+R+"!")    
def about():
	print("\r\r"+B+"<<<<<<| "+R+"About Tool "+B+"|>>>>>>\n")
	print("\r"+G+"Made"+B+" with full"+R+" <3"+B+"\r\r")
	print("\rAuthor  : ⊱XͭPͪLͤᗝIƬ༻₁₀₀ᵏ\t\t\t")
	print("\rVersion : 1.1\r\r\r")
	print("\rTeam    : "+R+"Sollo No Team")
	print("\r"+B+"Thanks to Use This Tools")
	menu()
